  ...
  return (
    <div className='h-[50vh] w-full' style={{
        ...
        <div className='w-full bg-neutral-700 bg-opacity-40 h-full flex items-center justify-evenly  px-10'>
            <div className='flex items-center justify-evenly lg:w-[70%] flex-col lg:flex-row space-y-5'>
            <div className='text-white lg:w-[70%]'>
            <h1 className='text-4xl font-semibold mb-3'>Speaking - Event</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
            </div>
            <button className='lg:w-[20%] border-white border text-white px-4 py-3 hover:bg-white hover:text-neutral-700 duration-500'>Contact Me</button>
            </div>
        </div>
